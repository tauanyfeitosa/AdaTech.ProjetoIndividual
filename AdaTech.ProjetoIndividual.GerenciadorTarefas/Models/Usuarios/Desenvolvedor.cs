...
namespace AdaTech.ProjetoIndividual.GerenciadorTarefas.Models.Usuarios
{
    ...
    {
        internal Desenvolvedor(string nome, string email, string senha, string cpf, string dataAdmissao, string dataNascimento, string genero, string dataDemissao = null) 
